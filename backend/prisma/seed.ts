  ...
  const users = [
    {
      ...
      healthInfo: [],
      emergencyContacts: [
        { name: 'Test Contact', phone: '+1555000001', relationship: 'Friend' },
      ],
    ...
    },
    {
      ...
      healthInfo: ['Type 2 diabetes', 'High blood pressure'],
      emergencyContacts: [
        { name: 'Jane Doe', phone: '+1555000002', relationship: 'Spouse' },
        { name: 'Mike Smith', phone: '+1555000003', relationship: 'Friend' },
      ],
      interests: ['Reading', 'Cooking', 'Walking'],
    },
    {
      ...
      healthInfo: [],
      emergencyContacts: [
        { name: 'Tom Johnson', phone: '+1555000005', relationship: 'Brother' },
      ],
      interests: ['Volunteering', 'Community Service', 'Gardening'],
      availability: [
    ...
    {
      email: 'michael.elder@example.com',
      ...
      profile: {
        ...
        date_of_birth: new Date('1950-07-20'),
        gender: 'Male',
        address: '789 Pine Street',
      },
      healthInfo: ['Arthritis', 'Osteoporosis', 'High blood pressure'],
      emergencyContacts: [
        { name: 'Lisa Brown', phone: '+1555000007', relationship: 'Daughter' },
        { name: 'Dr. Smith', phone: '+1555000008', relationship: 'Doctor' },
      ],
      interests: ['Reading', 'Music', 'Art'],
    },
    {
      email: 'admin@example.com',
      phone_number: '+1555000009',
      role: 'ADMIN' as const,
      profile: {
      ...
      healthInfo: [],
      emergencyContacts: [
        { name: 'Emergency Contact', phone: '+1555000010', relationship: 'Emergency' },
      ],
      interests: ['Technology', 'Community Service'],
    },
    {
      email: 'organizer@example.com',
      phone_number: '+1555000011',
      ...
      healthInfo: [],
      emergencyContacts: [
        { name: 'David Davis', phone: '+1555000012', relationship: 'Husband' },
      ],
      interests: ['Community Service', 'Volunteering', 'Sports'],
    },
  ];
